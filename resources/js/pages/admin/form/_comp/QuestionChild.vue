<template>
  <div class="ml-4 form-question form-question--child">
    ...
    <div v-show="question.showQuestionChild">
      <draggable
        v-model="question.question_childs"
        item-key="id"
        ...
        v-bind="{
          animation: 0,
          group: 'question-child',
          disabled: false,
          ghostClass: 'ghost',
        }"
        handle=".drag-handle--2"
      >
        <template #item="{ element: questionChild, index: questionChildIndex }">
          <div
            class="bg-white pt-6 px-6 border rounded-lg shadow-lg mb-8"
            :class="`${questionChild.additionClassNames}`"
          >
            <div class="drag-handle--2 cursor-pointer -mt-5">
            ...
            <div class="flex items-start w-full">
              ...
              <div class="flex-1">
                  ...
                  <div class="w-3/4">
                    ...
                    <div class="flex justify-end mb-3">
                      <span
                        ...
                        "
                        @click="
                          questionChild.showHint = !questionChild.showHint
                        "
                      >
                        <ph-plus
                      ...
                      <span
                        v-if="
                          allowedDefaultValueTypes.includes(questionChild.type)
                        "
                        class="
                          flex
                          items-center
                ...
                <div
                  class="mb-4 mt-2"
                  v-if="
                    questionChild.showHint || questionChild.showDefaultValue
                  "
                >
                  <div
                    v-if="questionChild.showHint"
                ...
                >
                  <li
                    v-for="(
                      option, optionIndex
                    ) in questionChild.question_options"
                    :key="optionIndex"
                  ...
                  <div class="mt-2">
                    <ol class="text-base text-gray-700 space-y-2">
                      <li class="flex items-center justify-between max-w-xs">
                        ...
                        >
                          <span>{{
                            questionChild.question_rate.lowest_rate
                          }}</span>
                          <Input
                            ...
                            class="flex-1"
                            v-model="
                              questionChild.question_rate.lowest_rate_label
                            "
                          />
                        </label>
                      </li>
                      <li class="flex items-center justify-between max-w-xs">
                        ...
                        >
                          ...
                          <Input
                            ...
                            class="flex-1"
                            v-model="
                              questionChild.question_rate.highest_rate_label
                            "
                          />
                        </label>
                      </li>
